...
c_a_filt = real(fft(c_a(1:N).*filter));
c_i_filt = real(fft(c_i(1:N).*filter));
...
figure(5)
plot((1:1:N),[20*c_a_filt, 20*log10(LPPspec_a)])
...
figure(6)
plot((1:1:N),[20*c_i_filt, 20*log10(LPPspec_i)])
...
figure(7)
plot((1:1:N),[20*c_n_filt, 20*log10(LPPspec_n)])
...
figure(8)
plot((1:1:N),[20*c_s_filt, 20*log10(LPPspec_s)])
